...
import static no.nordicsemi.android.swaromesh.Features.DISABLED;
import static no.nordicsemi.android.swaromesh.Features.ENABLED;
import static no.nordicsemi.android.swaromesh.utils.Heartbeat.COUNT_MIN;
import static no.nordicsemi.android.swaromesh.utils.Heartbeat.DEFAULT_PUBLICATION_TTL;
import static no.nordicsemi.android.swaromesh.utils.Heartbeat.PERIOD_LOG_MIN;
import static no.nordicsemi.android.swaromesh.utils.Heartbeat.calculateHeartbeatCount;
import static no.nordicsemi.android.swaromesh.utils.Heartbeat.calculateHeartbeatPeriod;
import static no.nordicsemi.android.swaromesh.utils.Heartbeat.periodToTime;
import static no.nordicsemi.android.swaromesh.utils.Utils.EXTRA_DATA;
import static no.nordicsemi.android.swaromesh.utils.Utils.HEARTBEAT_PUBLICATION_NET_KEY;
...
import no.nordicsemi.android.swaromesh.databinding.ActivityHeartbeatPublicationBinding;
...
import no.nordicsemi.android.swaromesh.node.dialog.DestinationAddressCallbacks;
import no.nordicsemi.android.swaromesh.node.dialog.DialogFragmentHeartbeatDestination;
import no.nordicsemi.android.swaromesh.node.dialog.DialogFragmentHeartbeatPublishTtl;
import no.nordicsemi.android.swaromesh.node.dialog.DialogFragmentTtl;
import no.nordicsemi.android.swaromesh.viewmodels.HeartbeatViewModel;
