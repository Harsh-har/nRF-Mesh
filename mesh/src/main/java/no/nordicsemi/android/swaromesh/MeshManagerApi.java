...
import no.nordicsemi.android.swaromesh.data.ApplicationKeyDao;
import no.nordicsemi.android.swaromesh.data.ApplicationKeysDao;
import no.nordicsemi.android.swaromesh.data.GroupDao;
import no.nordicsemi.android.swaromesh.data.GroupsDao;
import no.nordicsemi.android.swaromesh.data.MeshNetworkDao;
import no.nordicsemi.android.swaromesh.data.NetworkKeyDao;
import no.nordicsemi.android.swaromesh.data.NetworkKeysDao;
import no.nordicsemi.android.swaromesh.data.ProvisionedMeshNodeDao;
import no.nordicsemi.android.swaromesh.data.ProvisionedMeshNodesDao;
import no.nordicsemi.android.swaromesh.data.ProvisionerDao;
import no.nordicsemi.android.swaromesh.data.ProvisionersDao;
import no.nordicsemi.android.swaromesh.data.SceneDao;
import no.nordicsemi.android.swaromesh.data.ScenesDao;
...
import no.nordicsemi.android.swaromesh.transport.NetworkLayerCallbacks;
import no.nordicsemi.android.swaromesh.transport.ProvisionedMeshNode;
import no.nordicsemi.android.swaromesh.transport.UpperTransportLayerCallbacks;
import no.nordicsemi.android.swaromesh.utils.ExtendedInvalidCipherTextException;
...
public class MeshManagerApi implements MeshMngrApi {
    ...
    private List<ApplicationKey> generateAppKeys(final String meshUuid) {
        ...
        int numberOfAppKeys = 1;

        for (int i = 0; i < numberOfAppKeys; i++) {
