...
/**
 * To be used as a wrapper class to create light ctl temperature range set message.
 */
public class LightCtlTemperatureRangeSet extends ApplicationMessage {

    private static final String TAG = LightCtlSet.class.getSimpleName();
    private static final int OP_CODE = ApplicationMessageOpCodes.LIGHT_CTL_TEMPERATURE_RANGE_SET;
    ...
    /**
     * Constructs LightCtlTemperatureRangeSet message.
     *
     ...
     */
    public LightCtlTemperatureRangeSet(@NonNull final ApplicationKey appKey,
                                       final int rangeMin,
