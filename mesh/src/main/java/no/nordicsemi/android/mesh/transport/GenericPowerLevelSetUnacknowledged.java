...
public class GenericPowerLevelSetUnacknowledged extends ApplicationMessage {
    ...
    public String toString() {
        if (mIsLongCommand) {
            ...
            return "GenericPowerLevelSetUnacknowledged{" +
                    "type=LONG_COMMAND" +
                    ", command=" + mCommand +
                    ", length=" + mLength +
                    ", data=" + dataStr +
    ...
    public static class Builder {
        ...
        public GenericPowerLevelSetUnacknowledged build() {
            if (isLongCommand) {
                return new GenericPowerLevelSetUnacknowledged(appKey, command, length, dataArray, tid);
            } else {
                return new GenericPowerLevelSetUnacknowledged(appKey, command, powerLevel, tid);
            }
        }
    }
}