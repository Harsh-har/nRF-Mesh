...
MAC Address Visibility Extended mesh database and UI layers to: Display BLE MAC Address alongside Node Name and UUID Persist MAC address mapping after provisioning Helps in: Device identification Debugging Field installation & maintenance
...
UI & UX Improvements Cleaner node listing with: Device Name MAC Address UUID Faster navigation and improved control screens. Optimized workflows for provisioning and configuration.
